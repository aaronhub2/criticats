...
function getReviewsUID($conn, $user_id) {
    $stmt = $conn->prepare("SELECT ID, Titulo, User_ID, Content_ID, text, rating, tipo FROM reviews WHERE User_ID = ?");
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $reviews = getReviewsUID($conn, $user_id);
