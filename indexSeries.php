...
<head>
    ...
    <script src="scripts/scrollseries.js"></script>
...
<body>
    ...
    <header class="row">
            <div class="col-6 text-start">
                <a href="index.php"><img src="img/Criticatslogo.png" id="headerlogo" alt="Crtiticats Logo"></a>
            </div>
